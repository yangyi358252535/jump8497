...
<h3 id="h3_head">
	<a href="#" style="color: white">奖项信息列表</a>-><span style="color: white">添加奖项信息</span>
	<%@ include file="../../template/H3_header.jsp"%>
</h3>
<form action="../systemManage/award/addProcess.action" method="post"
	id="addForm">
	<div id="topDIV">
		<table class="list" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td colspan="2"><div align="left">
						&nbsp;&nbsp;
						<s:textfield name="awards.name" id="name" cssClass="inputTextStyle" maxlength="20" />
