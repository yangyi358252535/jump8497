...
<script type="text/javascript"
	src="../systemManage/clazz/js/clazz_main.js" charset="UTF-8"></script>
<script>
</script>
<div class="menubar" id="clazzbar" align="right">
...
<div class="rightlist" id="clazz_main"></div>
</div>
